...
const unknownParameter = (key) => console.log(`${unknownArgument} ${key}`);
exports.unknownParameter = unknownParameter;
const noParameterFromSsm = (key) => console.log(`No parameter found in SSM Param Store for: ${key}. Setting value as null.`);
